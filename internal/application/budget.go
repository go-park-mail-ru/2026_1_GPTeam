...
type BudgetUseCase interface {
	Create(ctx context.Context, budget models.BudgetModel, category string) (int, error)
...
func (obj *Budget) Create(ctx context.Context, budget models.BudgetModel, category string) (int, error) {
