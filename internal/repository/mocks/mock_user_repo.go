...
func (mr *MockUserRepositoryMockRecorder) Update(ctx, profile interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) UpdateLastLogin(ctx, userId, lastLogin interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
