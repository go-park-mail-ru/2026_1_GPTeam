...
func (mr *MockAccountRepositoryMockRecorder) GetByAccountId(ctx, accountId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetOwnerByAccountId mocks base method.
func (m *MockAccountRepository) GetOwnerByAccountId(ctx context.Context, accountId int) (int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOwnerByAccountId", ctx, accountId)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetOwnerByAccountId indicates an expected call of GetOwnerByAccountId.
func (mr *MockAccountRepositoryMockRecorder) GetOwnerByAccountId(ctx, accountId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOwnerByAccountId", reflect.TypeOf((*MockAccountRepository)(nil).GetOwnerByAccountId), ctx, accountId)
}
